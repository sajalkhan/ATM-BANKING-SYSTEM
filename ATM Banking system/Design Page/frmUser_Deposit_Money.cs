...
{
    public partial class frmUser_Deposit_Money : Form
    {
        public double Money;
        public string password;
        public int User_Id;
        public string Name;
        public frmUser_Deposit_Money(double m,string p,int id,string n)
        {
            InitializeComponent();
            Money = m;
            password=p;
        ...
        private void enter_Click(object sender, EventArgs e)
        {
            ...
            u.Id = User_Id;
            u.Balance = Amount;
            if (u.Update()) MessageBox.Show("Account info Updated!");
            else MessageBox.Show(u.Error);
        }
